...
app.post('/register', async (req, res) => {
  ...
  try {
    ...
    // Fetch line manager name from line_managers table
    ...
    await db.query(
      `INSERT INTO users
      (first_name, last_name, email, password, date_of_joining, line_manager_id, line_manager, job_title)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
      [first_name, last_name, email, hashedPassword, date_of_join, line_manager_id, line_manager_name, job_title]
    );
